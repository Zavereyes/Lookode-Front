...
const Formulariodatos = ({ 
    ...
    const desactivarCuenta = () => {
        ...
        axios.put(`https://lookode-back.onrender.com/usuario/desactivar/${usuario.idUsuario}`, {}, {
    ...
    useEffect(() => {
        if (modo === 'editar' && usuario?.idUsuario && !fileImg) { 
            axios.get(`https://lookode-back.onrender.com/usuario/avatar/${usuario.idUsuario}`, { 
                responseType: 'blob',
                headers: {
    ...
    const handleSubmit = (e) => {
        ...
        if (modo === 'registro') {
            // Proceso de registro
            axios.post("https://lookode-back.onrender.com/registro", formData, {
            ...
            axios.put("https://lookode-back.onrender.com/usuario/editar", formData, {
                headers: { 
